...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        MainWindowClass->resize(921, 476);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(MainWindowClass->sizePolicy().hasHeightForWidth());
        MainWindowClass->setSizePolicy(sizePolicy);
        MainWindowClass->setMinimumSize(QSize(921, 476));
        MainWindowClass->setMaximumSize(QSize(921, 476));
        ...
        label->setGeometry(QRect(10, -10, 901, 481));
        sizePolicy.setHeightForWidth(label->sizePolicy().hasHeightForWidth());
        label->setSizePolicy(sizePolicy);
        label->setMinimumSize(QSize(901, 481));
        label->setMaximumSize(QSize(901, 481));
        label->setPixmap(QPixmap(QString::fromUtf8("../qtautosar/dash.png")));
...
"					"));
        ...
        battery_b->setPixmap(QPixmap(QString::fromUtf8("../qtautosar/batterydown.png")));
        ...
        opendoor_b->setPixmap(QPixmap(QString::fromUtf8("../qtautosar/opendoor.png")));
        ...
        rarrow_b->setPixmap(QPixmap(QString::fromUtf8("../qtautosar/arrow.png")));
    ...
    {
        MainWindowClass->setWindowTitle(QCoreApplication::translate("MainWindowClass", "Controller (Client)", nullptr));
        ...
        label_2->setText(QCoreApplication::translate("MainWindowClass", "<html><head/><body><p align=\"justify\"><span style=\" color:#ffffff;\">GPU is idle</span></p></body></html>", nullptr));
    } // retranslateUi
